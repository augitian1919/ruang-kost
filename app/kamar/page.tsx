...
// Sesuaikan path ini dengan posisi file Anda saat ini
            ...
            {kamars.map((kamar) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <a 
                    href={`https://wa.me/6281234567890?text=Halo, saya ingin memesan Kamar ${kamar.nomor_kamar}`} 
                    target="_blank"
                    className="mt-3 inline-block bg-slate-900 text-white px-6 py-2 rounded-lg text-sm font-semibold hover:bg-slate-800 transition"
                  >
                    Booking Sekarang
                  </a>
                </div>
