...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800">
      ...
      <nav className="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/login">
              <button className="px-5 py-2 bg-blue-600 text-white rounded-full text-sm font-semibold hover:bg-blue-700 transition-all">
                Masuk
              </button>
            </Link>
          </div>
      ...
      {/* ===== HERO SECTION - BACKGROUND PUTIH BERSIH ===== */}
      <section className="pt-16 pb-20 px-4 bg-white">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/kamar-tersedia">
              <button className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold text-sm shadow-lg transition-all flex items-center gap-2">
                🔍 Lihat Pilihan Kamar
              </button>
            </Link>
            <Link href="/kontak">
              <button className="px-8 py-4 bg-white text-slate-700 border-2 border-slate-300 hover:border-blue-400 hover:text-blue-600 rounded-xl font-bold text-sm transition-all">
                📞 Hubungi Pemilik
              </button>
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={idx} className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 hover:shadow-md hover:-translate-y-1 transition-all text-center">
                <div className="w-14 h-14 mx-auto mb-4 bg-blue-100 rounded-2xl flex items-center justify-center text-3xl">
                  {item.icon}
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10">
            <div>
              ...
              <p className="text-slate-600">Pilihan kamar favorit penghuni kami.</p>
            </div>
            <Link href="/kamar-tersedia">
              ...
              {kamars.map((kamar) => {
                ...
                return (
                  <Link key={kamar.id} href={`/kamar/${kamar.id}`}>
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all cursor-pointer group">
                      <div className="h-52 relative overflow-hidden">
                        ...
                        <div className="absolute top-3 right-3 px-2 py-1 bg-emerald-500 rounded-lg text-xs font-bold text-white">
                          Tersedia
                        </div>
      ...
      <section className="py-20 px-4 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          <div className="bg-blue-600 rounded-3xl p-10 sm:p-16 text-center text-white relative overflow-hidden">
      ...
      <footer className="bg-slate-900 text-white py-10 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-8">
            <div>
              <h3 className="font-extrabold text-lg text-blue-400 mb-2">
                RuangKost
              </h3>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li><Link href="/kamar-tersedia" className="hover:text-blue-400 transition-colors">Kamar Tersedia</Link></li>
                <li><Link href="/login" className="hover:text-blue-400 transition-colors">Masuk</Link></li>
                <li><Link href="/register" className="hover:text-blue-400 transition-colors">Daftar</Link></li>
              </ul>
            </div>
            <div>
